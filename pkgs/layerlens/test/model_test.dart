...
void main() {
  test('SourceNode returns correct relative paths', () async {
    ...
    expect(
      nodes['a']!.relativePathTo(nodes['a/sub/asa']!),
      equals(['sub', 'asa']),
    );
    ...
    expect(
      nodes['a/aa']!.relativePathTo(nodes['a/sub/asa']!),
      equals(['sub', 'asa']),
    );
    expect(
      nodes['a/sub/asa']!.relativePathTo(nodes['a/aa']!),
      equals(['..', 'aa']),
    );
    expect(
      nodes['a/sub/asa']!.relativePathTo(nodes['b']!),
      equals(['..', '..', 'b']),
    );
    expect(
      nodes['a/sub/asa']!.relativePathTo(nodes['a']!),
      equals(['..', '.']),
    );
    expect(nodes['a/sub/asa']!.relativePathTo(nodes['a/sub']!), equals(['.']));
    expect(
      nodes['a/sub/asa']!.relativePathTo(nodes['b/bb']!),
      equals(['..', '..', 'b', 'bb']),
    );
    expect(
      nodes['a/aa']!.relativePathTo(nodes['b/bb']!),
      equals(['..', 'b', 'bb']),
    );
    expect(
      nodes['b/bb']!.relativePathTo(nodes['a/sub/asa']!),
      equals(['..', 'a', 'sub', 'asa']),
    );
  });

  test('SourceNode returns correct relative paths for the root folder',
      () async {
    ...
    expect(
      nodes['bin/main']!.relativePathTo(nodes['lib/main']!),
      equals(['..', 'lib', 'main']),
    );
  });
}
